...
const CartItem = (props) => {
  ...
  console.log(props)
    return <Wrapper>
       {props.cartItem.count >0 && <div className="mt-5">
        <div className="row cart">
            ...
            <div className="col position-relative ">
                <div className="position-absolute top-50 start-50 translate-middle">
                    <svg   onClick={()=>props.removefromCart(props.cartItem.id)} className="bg-danger plusBtn" width="14" height="14" viewBox="0 0 14 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="ms-2 mt-2 ">{props.cartItem.count}</span>
                    <svg  onClick={()=>props.addtoCart(props.cartItem.id)} className="bg-success ms-2 plusBtn" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="col d-flex justify-content-around">
                ...
                <svg onClick={()=>props.cross(props.cartItem.id)} className="bg-success  mt-4 cross" width="12" height="11" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
